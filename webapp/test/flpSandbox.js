		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PO Inbox",
									"targetURL": "#comibscmsdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibscmsdemo-display": {
								"semanticObject": "comibscmsdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibscms.demo",
									"url": sap.ui.require.toUrl("com/ibscms/demo")
								}
							}
						}
					}
